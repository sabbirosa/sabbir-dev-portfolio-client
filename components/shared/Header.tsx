    ...
    <>
      ...
      <nav className="nav max-w-screen-sm backdrop-blur-md pointer-events-auto sticky top-1 flex items-center justify-between gap-6 rounded-full py-2 mx-auto transition-colors z-50 px-6 mt-4">
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          >
            {currmode === "dark" ? (
              <div className="svgsun absolute inset-0 flex items-center justify-center transition-all">
                <svg
              ...
              <div className="svgmoon absolute inset-0 flex items-center justify-center transition-all">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
                  height="18"
