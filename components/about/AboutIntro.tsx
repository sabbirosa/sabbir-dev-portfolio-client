      ...
      <div className="relative flex flex-col lg:flex-row items-center justify-between w-full gap-8">
        ...
        <div className="w-full space-y-4 text-left max-md:text-start">
          <h1 className="text-4xl text-balance sm:text-7xl font-semibold py-5">
            ...
            <span className="text-[#7C3AED]">interactive, impactful</span> digital experiences
          </h1>
          <div className="text-right">
            <p className="text-balance sm:text-xl max-sm:text-start mb-10 max-md:ml-0 ml-40">
              ...
              />
              , a creative problem-solver dedicated to building scalable, user-friendly, and
              visually engaging applications. I strive to blend thoughtful design with robust
              functionality, ensuring seamless experiences across web platforms.
            </p>

            <a href="/Documents/Resume_Sabbir Bin Abdul Latif.pdf" download={"Sabbir Bin Abdul Latif's Resume"}>
